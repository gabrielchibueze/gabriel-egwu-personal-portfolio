        ...
        <div className="footer">
            <div className="footer-top">
                <div className="subscription">
                    ...
                    <p>Gabriel will never share or spam your email address. By clicking &quot;Subscribe&quot; you agree to the Terms of Use and Privacy Policy</p>
                </div>
                <div className="footer-main">
                    <div className="footer-first">
                        <p className="footer-headings">Gabriel Egwu</p>
                        <Link to="about">About me</Link>
                        <Link to="about/business&investment">Business & <br /> Investment</Link>
                    ...
                    <div className="footer-menu-links">
                        ...
                        <div className="footer-menu-social-links">
                            <Link to="https://github.com/gabrielchibueze" target="_blank" className="footer-socials"> <FaGithub /> GitHub</Link>
                            <Link to="https://www.facebook.com/egwu.gabrielchibueze" target="_blank" className="footer-socials"> <FaFacebookF /> Facebook</Link>
                            <Link to="https://linkedin.com/in/gabriel-egwu" target="_blank" className="footer-socials"> <FaLinkedinIn /> Linkedin </Link>
                            <Link to="https://twitter.com/ChibuezeEgwu" target="_blank" className="footer-socials"> <FaSquareXTwitter /> Twitter </Link>
                        </div>
                    </div>
                </div>
            </div>
